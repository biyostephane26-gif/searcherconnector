...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'Biyo Stéphane', url: 'https://searcherconnector.onrender.com' }],
  creator: 'Biyo Stéphane',
  metadataBase: new URL(process.env.NEXT_PUBLIC_APP_URL || 'https://searcherconnector.onrender.com'),
  openGraph: {
    type: 'website',
    locale: 'fr_FR',
    alternateLocale: ['en_US'],
    url: 'https://searcherconnector.onrender.com',
