      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="max-w-3xl mx-auto px-6 py-12 space-y-10 text-gray-300">
            ...
            {[
              { title: '1. Présentation du service', content: 'Searcher Connector ("le Service") est une plateforme d\'automatisation de la recherche d\'emploi, de missions freelance et d\'opportunités d\'investissement. Il est opéré par Biyo Stéphane, fondateur, domicilié au Cameroun. Le Service utilise des agents IA autonomes pour scanner des sources publiques du web et proposer des opportunités correspondant au profil de l\'utilisateur.' },
              ...
              { title: '3. Description des services', content: 'Searcher Connector propose : scan automatique d\'opportunités (emploi, freelance, investissement), scoring et filtrage par IA des résultats, génération de candidatures personnalisées, inbox unifiée (Gmail + WhatsApp), recherche de talents et portfolios, modules de prospection B2B, réseau social professionnel intégré, et agent IA (SCAI) disponible 24h/24.' },
